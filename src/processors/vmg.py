...
def process_vmg(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        classes = ["normal_vibration", "abnormal_low", "abnormal_high"]  # Changed from healthy/myopathy/neuropathy
        class_names = {
            "normal_vibration": "Normal Muscle Vibration Pattern",
            "abnormal_low": "Low Vibration Amplitude (Muscle Weakness)",
            "abnormal_high": "High Vibration Amplitude (Muscle Tension)"
        }
...
Data Points: 1000 normalized vibration samples"""
        ...
        clinical_recommendations = {
            "normal_vibration": """Normal muscle vibration patterns detected.
- Muscle function appears normal
- Continue regular physical activity
- Routine monitoring as needed""",
            "abnormal_low": """Low vibration amplitude detected.
- May indicate muscle weakness or fatigue
- Consider strength training program
- Monitor for progression
- Correlate with clinical symptoms""",
            "abnormal_high": """High vibration amplitude detected.
- May indicate muscle tension or spasticity
